...
## Docker Monitoring (inkl. GUI)

Vorteile von Monitoring:

- Überwachung mit modernster RMM Software (Remote Monitoring and Management)
- alle Systeme laufend in Echtzeit überwacht
- Es werden deren Komponenten auf ihre Verfügbarkeit und fehlerfreie Funktion überprüft.
- Sämtliche Abweichungen und Anomalien werden zentralisiert protokolliert und automatisch den zuständigen Spezialisten mit entsprechendem Dringlichkeitsgrad zur Erledigung rapportiert.

Monitoring ist aufgrund der sehr hohen Anforderungen an die heutige IT-Infrastruktur extrem wichtig.
Der Administrator muss jeder zeit wissen wie es seiner Infrastruktur geht. Sprich die Komplette Auslastung muss irgendwo erfasst werden und wenn Fehler auftretten müssen die Administratoren benachrichtigt werden.

Auch für die Docker-Umgebung ist es notwenig, dass die Container überwacht werden.
...
Da das Monitoring ein sehr zentraler Dienst ist, ist es bei Angreiffern ein beliebtes Ziel. Desswegen ist es wichtig die Übertragungen der Messwerte und der Auswertung mittels Verschlüsslungstechnlogien zu verschlüsseln.

Einfachheits halber habe ich den Port 80 auf 8880 geändert. Um auf das GUI des Monitoring zu kommen, muss der Angreiffer nun zuerst noch den richtigen Port erwischen.

### Screenshots

#### Hardware

![Alt-Text](https://alighome01.myqnapcloud.com/share.cgi/Docker_Monitoring_2.jpeg?ssid=0okiiNo&fid=0okiiNo&path=%2F&filename=Docker_Monitoring_2.jpeg&openfolder=normal&ep=)


![Alt-Text](https://alighome01.myqnapcloud.com/share.cgi/Docker_Monitoring_1.jpeg?ssid=0okiiNo&fid=0okiiNo&path=%2F&filename=Docker_Monitoring_1.jpeg&openfolder=normal&ep=)